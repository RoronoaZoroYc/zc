(function() {
    var h = {},
        mt = {},
        c = {
            id: "85581f8cde4d7458db2ff4ea38053423",
            dm: ["catl.com"],
            ...
            cptrk: [],
            icon: '',
            ctrk: ["%5b%22catl.com%22%2c%22catl.com%5c%2fresearch%5c%2ftechnology%22%2c%22catl.com%5c%2fservice%22%5d"],
            vdur: 1800000,
            age: 31536000000,
            qiao: 0,
            pt: 0,
    ...
    (function() {
        ...
        mt.d.getAttribute = function(b,
            ...
            if (!d && b.attributes && b.attributes.length)
                for (var f = b.attributes, e = f.length, l = 0; l < e; l++) f[l].nodeName === a && (d = f[l].nodeValue);
            return d
        };
        mt.d.Qa = function(b) {
            var a = "document";
            ...
            (mt.d.bc = function() {
                ...
                (function() {
                    if (!d)
                        ...
                        else if (document.addEventListener) document.addEventListener("DOMContentLoaded", e, x), window.addEventListener("load",
                        b, x);
        ...
        return function(b) {
            switch (typeof b) {
                ...
                default:
                    ...
                    l = mt.w.stringify;
                    for (f in b)
                        if (Object.prototype.hasOwnProperty.call(b, f)) switch (r =
                            b[f], typeof r) {
                            case "undefined":
                            case "unknown":
                            case "function":
        ...
        mt.A.wa = function(a) {
            ...
            try {
                ...
                "GET" === g && (d && (f += (0 <= f.indexOf("?") ? "&" : "?") + d,
                    d = u), p && (f += (0 <= f.indexOf("?") ? "&" : "?") + "b" + +new Date + "=1"));m.open(g, f, t);m.onreadystatechange = function() {
                    if (4 === m.readyState) {
                        var a = 0;
                        try {
                            a = m.status
                ...
                for (var w in l) l.hasOwnProperty(w) && m.setRequestHeader(w, l[w]);n && (m.withCredentials = t);r && (q = setTimeout(function() {
                    ...
                    return function(g) {
                        ...
                        if (l) {
                            ...
                            if (p && p === g) l.removeAttribute(d.P);
                                ...
                                if (r = l.length, p = l[l.length - 1], 1E4 > r * p.split(">").length)
                ...
                ua: function() {
                    ...
                    if (!document.addEventListener)
                        for (var f = b.H(c.etrk) || [], g = 0; g < f.length; g++) {
                            var l = f[g]; - 1 === l.indexOf(">") && (0 === l.indexOf("#") && (l = l.substring(1)), (l = e.La(l)) && a.c(l, "click", k.zb(d), t))
                        }
                },
                ba: function(a) {
                ...
                _providePlugin: function(a) {
                    if (1 < a.length) {
                        var d = window._hmt,
                            e = a[1];
                        a = a[2];
                        if (b.X(f.na, e) && b.j(a) && (d.plugins = d.plugins || {}, d.z = d.z || {}, d.plugins[e] = a, d.l = d.l || [], a = d.l.slice(), e && a.length && a[0][1] === e))
                            for (var g = 0, k = a.length; g < k; g++) {
                                var l = a[g][2] || {};
                                if (d.plugins[e] && !d.z[e]) d.z[e] = new d.plugins[e](l), d.l.shift();
                                else break
                            }
                    }
                },
                _requirePlugin: function(a) {
                    if (1 <
                        ...
                        var d = window._hmt,
                            ...
                            g = a[2] || {};
                        if (b.X(f.na, e))
                            if (d.plugins = d.plugins || {}, d.z = d.z || {}, d.plugins[e] && !d.z[e]) d.z[e] = new d.plugins[e](g);
                            else {
                                d.l = d.l || [];
    ...
    (function() {
        function e() {
            "undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = t, this.a = {}, this.ob = this.ia = this.ha = t, this.ga = m.ga, this.Tb = k.Z(c.aet) && 0 < c.aet.length ? c.aet.split(",") : "", this.D())
        }
        var a = mt.url,
            b = mt.A,
            k = mt.lang,
        ...
        e.prototype = {
            ...
            nb: function() {
                ...
                return !k.X("sjh.baidu.com isite.baidu.com ls.wejianzhan.com bs.wejianzhan.com product.weijianzhan.com qianhu.weijianzhan.com aisite.wejianzhan.com".split(" "),
                    b)
            },
            Aa: function() {
            ...
            pa: function() {
                for (var a = [], b = this.a.et, d = 0, e = m.ra.length; d < e; d++) {
                    ...
                    "undefined" !== typeof g && "" !== g &&
                        ("tt" !== f || "tt" === f && 0 === b) && a.push(f + "=" + encodeURIComponent(g))
                }
                return a.join("&")
            },
            Fb: function() {
            ...
            D: function() {
                try {
                    this.Aa(), this.Fb(), this.Cb(), h.b = this, this.za(), this.tb(), v.k("pv-b"), this.ob && this.Bb()
                } catch (a) {
                    var d = [];
                    d.push("si=" + c.id);
